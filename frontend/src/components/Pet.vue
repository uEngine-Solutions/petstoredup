<template>
    ...
    <v-card style="width:450px;" outlined>
        ...
        <v-card-text>
            ...
            <int offline label="Appearance" v-model="value.appearance" :editMode="editMode" @change="change"/>
            <int offline label="Energy" v-model="value.energy" :editMode="editMode" @change="change"/>
